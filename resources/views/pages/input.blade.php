...
<div style="max-width: 800px; margin: 0 auto;">
    ...
    <div class="header-responsive">
        <div>
            <h1 class="page-title">Manual Account Input</h1>
            <p class="page-subtitle">Add new account data to the database.</p>
        </div>
    ...
    <div class="card">
        <form action="{{ route('account.store') }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-bottom: 20px;">
                ...
                <div>
                    <label style="display: block; font-weight: 600; margin-bottom: 8px; font-size: 0.9rem; color: var(--text-main);">Account Category</label>
                    ...
                    @if($categories->count() == 0)
                        <div style="margin-top: 5px; font-size: 0.8rem; color: var(--danger);">
                            ...
                            @if(Auth::user()->role == 'admin')
                                <a href="{{ route('settings') }}" style="text-decoration: underline; color: var(--danger);">Create one in Settings first</a>.
                            @else
                                Contact Admin.
                            @endif
                        </div>
                ...
                <div>
                    ...
                    <input type="text" name="username" value="{{ request('username') }}" placeholder="Enter username..." required
            ...
            <div style="margin-bottom: 30px;">
                ...
                <input type="text" name="password" value="{{ request('password') }}" placeholder="Enter password..." required
    ...
    @if(request('username'))
        <div style="text-align: center; color: var(--success); font-weight: 500; margin-top: 15px; font-size: 0.9rem;">
            ✅ Generator data loaded automatically.
        </div>
    @endif
